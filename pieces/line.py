    ...
    if len(contours) == 3:
        ...
        if len(corners) > 3:
            ...
            for corner in corners:
                cornerX = corner[0]
                cornerY = corner[1]
                if (cornerX < p1x / pn1 + offset) and (cornerX > p1x / pn1 - offset) and (
                        cornerY < p1y / pn1 + offset) and (cornerY > p1y / pn1 - offset):
                    p1x = p1x + cornerX
                    p1y = p1y + cornerY
                    pn1 = pn1 + 1
                else:
                    if pn2 == 0:
                        ...
                        p2y = cornerY
                        pn2 = pn2 + 1
                    elif (cornerX < p2x / pn2 + offset) and (cornerX > p2x / pn2 - offset) and (
                            cornerY < p2y / pn2 + offset) and (cornerY > p2y / pn2 - offset):
                        p2x = p2x + cornerX
                        p2y = p2y + cornerY
                        pn2 = pn2 + 1
                    else:
                        if pn3 == 0:
                            ...
                            p3y = cornerY;
                            pn3 = pn3 + 1;
                        elif (cornerX < p3x / pn3 + offset) and (cornerX > p3x / pn3 - offset) and (
                                cornerY < p3y / pn3 + offset) and (cornerY > p3y / pn3 - offset):
                            p3x = p3x + cornerX;
                            p3y = p3y + cornerY;
                            pn3 = pn3 + 1;
...
for file in onlyfiles:
    ...
    if len(contours) == 1:
        ...
        if M['m00'] > 100:
            ...
            cv2.rectangle(img, (x, 130 + y), (x + w, 130 + y + h), (0, 255, 255), 1)
            midOfWhiteSqr = (x + w / 2);
            midOfGreenSqr = 152;
            ...
            if w < 130:
                ...
                isTriangleFound = False
        # rectangle main
        cv2.rectangle(img, (0, 130), (300, 170), (0, 255, 0), 1)
        # centre line
        cv2.line(img, (152, 130), (152, 170), (0, 255, 0), 1)
